        ...
        <div className="p-4 flex flex-col justify-between h-full ">
          <Link to={"/book/" + id} className="text-black ">
            <div className={`bg-[#bbf7d0]`} style={styles.container}>
              ...
              <p className="mt-2 text-center font-light hover:text-white">
                {author}
              </p>
              <p className="mt-2 text-center font-bold text-xl hover:text-black">
                ${price}
              </p>
            </div>
          </Link>
        ...
        <div className="p-4 flex flex-col justify-between h-full ">
          <Link to={"/book/" + id} className="text-black ">
            <div className={`bg-[#bbf7d0]`} style={styles.container}>
              ...
              <p className="mt-2 text-center font-extrabold text-lg hover:text-black">
                Out of stock
              </p>
            </div>
          </Link>
