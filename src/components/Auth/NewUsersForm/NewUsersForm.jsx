...
// Validación de campos obligatorios
    ...
    return (
        ...
        >
            ...
            >
                Username:{formSubmitted && input.username.trim() === "" && (
...
{/* 
            ...
            <label htmlFor="name"
                   className="block text-gray-700 text-sm font-bold my-2"
            >
                Name:{formSubmitted && input.name.trim() === "" && (
                <span className="text-red-500">*</span>
                )}
            </label>
            <input
            ...
            <label htmlFor="lastname"
                   className="block text-gray-700 text-sm font-bold my-2"
            >
                Lastname:{formSubmitted && input.lastname.trim() === "" && (
                <span className="text-red-500">*</span>
                )}
            </label>
            <input
            ...
            <label htmlFor="country"
                   className="block text-gray-700 text-sm font-bold my-2"
            >
                Country:{formSubmitted && input.country.trim() === "" && (
                <span className="text-red-500">*</span>
                )}
            </label>
            <input
            ...
            <label htmlFor="phone"
                   className="block text-gray-700 text-sm font-bold my-2"
            >
                Phone:{formSubmitted && input.phone.trim() === "" && (
                <span className="text-red-500">*</span>
                )}
            </label>
            <input
