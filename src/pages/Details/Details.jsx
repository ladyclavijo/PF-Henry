                        ...
                        {user ? (
                            ...
                            {book.stock > 0 ? (
                                ...
                                <>
                                    <div className="flex flex-row mt-4 mb-3">
                                        <div className="flex flex-col items-center">
                                            <h4 className="text-xl">Stock: SOLD OUT!</h4>
                                            <h4 className="text-xl">Seller: {book.userId || "BookBuster"}</h4>
                                        </div>
                                    </div>
                                    <div className="w-full flex flex-col">
                                        <button className="bg-[#91afae] text-white px-4 py-2 rounded-md mb-0.5 w-full" onClick={handleAddToCart} disabled={book.stock <= 0}>
                                            Add To Cart
                                        </button>
                                        <button className="bg-[#D9619A] text-white px-4 py-2 rounded-md mt-0.5 w-full" onClick={handleBuyClick} disabled={book.stock <= 0}>
                                            Buy it
                                        </button>
                                    </div>
                            ...
                            {book.stock > 0 ? (
                                <>
                                    <div className="flex flex-col items-center">
                                        <h4 className="text-xl">Stock: {book.stock}</h4>
                                        <h4 className="text-xl mb-4">Seller: {book.userId || "BookBuster"}</h4>
                                    </div>
                                <Link to="/login">
                                    <button className="bg-[#91afae] text-white px-4 py-2 rounded-md mb-0.5 w-full">Add To Cart</button>
                                </Link>
                                <Link to="/login">
                                    <button className="bg-[#D9619A] text-white px-4 py-2 rounded-md mt-0.5 w-full">Buy it</button>
                                </Link>
                                </>
                            ) : (
                                <>
